...
Name "XdevLSDK 0.2.0 for Visual Studio 2005"

; The file to write
OutFile "XdevLSDK-0.2.0_VS2005.exe"

;--------------------------------
;Interface Configuration

  !define MUI_HEADERIMAGE
  !define MUI_HEADERIMAGE_BITMAP icons\xdevl.bmp
...
File lib\XdevL.lib
File lib\XdevLd.lib
File lib\XdevLCore-0.2.0.dll 
File lib\XdevLCore-0.2.0d.dll 
...
File ..\XdevLPlugins\lib\XdevLAudioAL-0.2.0.dll
File ..\XdevLPlugins\lib\XdevLAudioAL-0.2.0d.dll
File ..\XdevLPlugins\lib\XdevLOgre-0.2.0.dll
File ..\XdevLPlugins\lib\XdevLOgre-0.2.0d.dll
File ..\XdevLPlugins\lib\XdevLOpenGL-0.2.0.dll
File ..\XdevLPlugins\lib\XdevLOpenGL-0.2.0d.dll
...
LangString DESC_xdevl_section ${LANG_ENGLISH} "Installs the XdevL include and library files."
LangString DESC_xdevl_plugins_section ${LANG_ENGLISH} "Installs XdevL additional plug-in include and library files."
LangString DESC_xdevl_demos_section ${LANG_ENGLISH} "Installs XdevL demo source files."
LangString DESC_xdevl_external_section ${LANG_ENGLISH} "Installs include and libraries which are necessary for some demo projects."
LangString DESC_xdevl_env_variables ${LANG_ENGLISH} "Installs the necessary XdevL environment variables."

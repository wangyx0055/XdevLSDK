  ...
  */
  class XdevLPluginInfo {
    public:
      ...
      XdevLPluginInfo(XdevLCreateModuleFunction c, XdevLDeleteModuleFunction d, XdevLGetPluginDescriptorFunction desc, XdevLSharedLibrary* dynlib) :
        m_createModule(c),
        m_deleteModule(d),
      ...
      /// Creates a module.
      int createModule(XdevLModuleCreateParameter* parameter) {

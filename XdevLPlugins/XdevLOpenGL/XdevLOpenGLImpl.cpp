...
#include <XdevLOpenGL/XdevLFrameBufferImpl.h>
...
xdl::XdevLModuleDescriptor openGLModuleDesc{xdl::vendor, 
                                            ...
                                            xdl::copyright, 
                                            xdl::description, 
                                            xdl::XdevLOpenGLMajorVersion, 
                                            xdl::XdevLOpenGLMinorVersion,
                                            xdl::XdevLOpenGLPatchVersion};

xdl::XdevLPluginDescriptor m_openglDescriptor{	xdl::pluginName,
																									xdl::moduleNames,
																									xdl::XdevLOpenGLPluginMajorVersion,
																									xdl::XdevLOpenGLPluginMinorVersion,
																									xdl::XdevLOpenGLPluginPatchVersion};
...
namespace xdl {
	...
	XdevLOpenGLImpl::XdevLOpenGLImpl(XdevLModuleCreateParameter* parameter) : XdevLModuleImpl<XdevLOpenGL330>(parameter, openGLModuleDesc),
		m_window(NULL),
		m_StencilDepth(8),
		m_ColorDepth(32),
		m_ZDepth(24),

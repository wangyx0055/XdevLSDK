...
namespace xdl {
	...
	static const XdevLString	pluginName 		{"XdevLOpenGL"};
	...
	*/
	class XdevLOpenGLImpl : public XdevLModuleImpl<XdevLOpenGL330> {
		public:
